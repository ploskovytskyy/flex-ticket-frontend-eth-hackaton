...
export default function AddItem({ label }: { label?: string }) {
  return (
    <div className="grid group gap-3 text-center content-center justify-center border rounded-lg px-4 py-5 hover:border-slate-300 cursor-pointer hover:shadow-lg transition-all">
